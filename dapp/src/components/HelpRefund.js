...
export default class HelpRefund extends Component {
  ...
  render() {
    return <div class="col-xl-8 offset-xl-2 text-justify border-top" id="refund-help">
      <Table>
      <Row>
        <Col xl={{ span: 12 }}>
          <h2 class="mt-5">How to Refund an Expired Option</h2>
          <p>
        ...
        <Col xl={{ span: 10, offset: 1 }}>
          <img src={refundImage} class="img-fluid" alt="refund-process"/>
        </Col>
      </Row>
      <Row class="mt-2">
        <Col xl={{ span: 6}}>
