...
export default class HelpBuy extends Component {
  ...
  render() {
    return <div class="col-xl-8 offset-xl-2 text-justify border-top" id="buy-help">
      <Table>
      <Row>
        <Col xl={{ span: 12 }}>
          <h2 class="mt-5">How to Buy an Option</h2>
          <p>
      ...
      <Row class="mt-2">
        ...
        <Col xl={{ span: 3}}>
          ...
          <p>
            ...
            In retunr you will receive XOpts token that represent your options.
          </p>
        </Col>
      </Row>
      </Table>
