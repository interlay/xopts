...
export default class HelpSell extends Component {
  ...
  render() {
    return <div className="col-xl-8 offset-xl-2 text-justify border-top" id="execute-help">
      <Table>
      <Row>
        <Col xl={{ span: 12 }}>
          <h2 className="mt-5">How to Exercise Options</h2>
          <p>
      ...
      <Row>
        ...
        <Col xl={{ span: 10, offset: 1 }}>
          <img src={requestExerciseImage} className="img-fluid" alt="exercise-process"/>
        </Col>
      </Row>
      ...
      <Row>
        ...
        <Col xl={{ span: 10, offset: 1 }}>
          <img src={executeExerciseImage} className="img-fluid" alt="exercise-process"/>
        </Col>
      </Row>
