import { Button, Container, Row, Table, Col, Form } from "react-bootstrap";
...
var steps = [
  ...
  { stepName: "Lock your BTC", component: FirstStep },
  // this step will be validated to false
  { stepName: "Confirmation", component: SecondStep },
];
          ...
          <Row>
            <Col xs={12} md={6} className="mr-auto ml-auto">
              <ReactWizard
                steps={steps}
                title="Lend"
                description="Put your BTC in the lending pool to earn variable interest"
                headerTextCenter
                validate
                color="primary"
